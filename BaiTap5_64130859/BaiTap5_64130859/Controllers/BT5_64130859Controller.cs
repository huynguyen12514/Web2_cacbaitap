...
using BaiTap5_64130859.Models;

namespace BaiTap5_64130859.Controllers
{
    public class BT5_64130859Controller : Controller
    {
        // GET: BT5_64130859
 ...
 emp.Email,emp.Password,emp.Department, postedFileName};
        ...
        public ActionResult SendMail(MailInfo model)
        {
            ...
            smtp.EnableSsl = true;
            smtp.Send(mail);
            return RedirectToAction("MailConfirm", "BT5_64130859");
        }
        public ActionResult MailConfirm(MailInfo emp)
        {
            return View();
        }
    }
